"""
Django settings for ProjectSupportCenter project.
...
ROOT_URLCONF = 'ProjectSupportCenter.urls'
...
WSGI_APPLICATION = 'ProjectSupportCenter.wsgi.application'
...
AUTH_USER_MODEL = 'pscmodels.User'
